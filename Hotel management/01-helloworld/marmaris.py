...
class marmarisClass:
    def __init__(self, root):
        ...
        #texts
        txt_htlid=Entry (self.root, textvariable=self.var_mrmhtl_id, font= ("goudy old style", 15), bg="white").place(x=150,y=150,width=180)
